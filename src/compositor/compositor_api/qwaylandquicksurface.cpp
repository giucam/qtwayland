...
{
public:
    QWaylandQuickSurfacePrivate(wl_client *client, uint32_t id, QWaylandQuickCompositor *c, QWaylandQuickSurface *surf)
...
QWaylandQuickSurface::QWaylandQuickSurface(wl_client *client, uint32_t id, QWaylandQuickCompositor *compositor)
                    : QWaylandSurface(new QWaylandQuickSurfacePrivate(client, id, compositor, this))
{
    ...
    connect(static_cast<QQuickWindow *>(compositor->window()), &QQuickWindow::beforeSynchronizing, this, &QWaylandQuickSurface::updateTexture, Qt::DirectConnection);
