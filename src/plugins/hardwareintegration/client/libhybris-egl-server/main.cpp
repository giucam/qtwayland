...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.WaylandClient.QWaylandServerBufferIntegrationFactoryInterface.5.2" FILE "libhybris-egl-server.json")
public:
    QStringList keys() const;
    QWaylandServerBufferIntegration *create(const QString&, const QStringList&);
};

QStringList LibHybrisEglServerBufferPlugin::keys() const
{
    QStringList list;
